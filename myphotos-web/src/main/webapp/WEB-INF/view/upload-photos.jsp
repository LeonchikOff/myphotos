...
<%@ page import="org.example.web.Constants" %>
    ...
    <article id="current-photo" class="6u 12u$(xsmall) photo-item not-init">
        <figure>
            <a href="#" class="image fit thumb large-photo">
                <img src="data:image/gif;base64,RO1GOD1hAQABAAD/ACwAAAAAAQABAAACADs=" class="small-photo" alt="Photo"/>
            </a>
            <figcaption>
                <p class="author">
                    <span class="uploaded-date">
                        <i class="fa fa-calendar" aria-hidden="true"></i> Uploaded: <span class="created"></span></span>
                </p>
                <p class="stat">
                    <span class="delim">|</span>
                    <span><i class="fa fa-eye" aria-hidden="true"></i> <span class="views"></span> <span class="txt">Views</span> |</span>
                    <span><i class="fa fa-download" aria-hidden="true"></i> <span class="downloads"></span> <span class="text">Downloads</span></span>
                </p>
                <p class="actions">
